...
function ShowTable() {
    ...
    const deleteScene = (id)=>{
        ...
        const newTransitions = transitions.filter((_, index)=>index !== sceneIndex && index !== sceneIndex - 1);
        setScenes(newScenes);
        setTransitions(newTransitions);
    };
    const updateSceneName = (id, newName)=>{
        const newScenes = scenes.map((scene)=>scene.id === id ? {
                ...scene,
                name: newName
            } : scene);
        setScenes(newScenes);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: scenes.map((scene, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    ...
                    index < scenes.length - 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Transition$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                        id: transitions[index]?.id || Date.now(),
                        from: scenes[index].name,
                        to: scenes[index + 1].name,
                        duration: transitions[index]?.duration || 10,
                        onDurationChange: (newDuration)=>updateTransitionDuration(transitions[index]?.id || 0, newDuration)
                    }, void 0, false, {
                        fileName: "[project]/src/components/ShowTable.tsx",
                        lineNumber: 74,
                        columnNumber: 13
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__17e00c._.js.map